...
10. Default tests remain deterministic and offline-safe.
11. Runtime changes under `vendors/openclaw-lite-main/src/openclaw-lite/*` must rebuild browser artifacts.
12. New worker-tool behavior must sync:

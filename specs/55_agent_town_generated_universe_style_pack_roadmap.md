...
```json
{
  ...
  "releaseGateCandidateReviewDiagnosticMetricTamperRejected": true,
  "releaseGateReadySourceEvidenceContextRequired": true,
  "releaseGatePrerequisiteEvidenceMetricTamperRejected": true,
  "releaseGateGeneratedPackPrerequisiteSourceContextRequired": true,
...
Release gates now have a companion `releaseEvidenceBundle` contract. The bundle is evidence-only: it does not approve production release, promote assets, expose generated packs in default gameplay, or alter server rules. It records stable hashes for the generated pack, measured playtest report, replayability diversity report, public card, persistence report, release approval evidence, candidate-review manifest, and release gate. It also records schema-bounded `sourcePackIds`, source-count metrics, source-problem count metrics, source-presence/hash coherence, source-coverage coherence, release-gate validity, release-gate ready-source and prerequisite-evidence binding, public-eligibility binding, bundle/gate timestamp ordering, blocking-reason binding, release-prerequisite snapshot binding, ready-evidence source binding, release-gate hash-match binding, generated-pack-source validation, playtest-source validation, persistence-source validation, public-card-source validation, approval-evidence-source validation, candidate-review manifest source validation, diversity-source pack inclusion/coherence, candidate-review manifest hash/time/count-match metrics, bounded approval-evidence/candidate-review diagnostic counts, and production-boundary metrics so single-pack evidence cannot be mixed into another pack's ready-gate bundle, source completeness and source mismatch evidence cannot be exaggerated, release-gate source-context failures cannot be hidden, review-order, count-match, or evidence-diagnostic failures cannot be hidden, and production/private-data boundary evidence remains fail-closed even when supplied source hashes are stable. A release evidence bundle must be validated with its bound release gate, and a ready gate requires every source hash to be present and to match the supplied source evidence and bound release gate; fail-closed bundles also reject hashes or pack ids claimed for unsupplied sources. Missing release-gate context, missing sources, unsupplied source hashes, unsupplied source pack ids, drifted evidence, invalid source pack-id shapes, mismatched pack ids, bundles that predate the gate, forged blocking reasons, forged prerequisite snapshots, failing generated-pack sources, failing playtest sources, failing persistence sources, failing public-card sources, failing approval-evidence sources, failing candidate-review manifest sources, copied diversity reports, approval evidence drift from the gate, tampered release-gate validity metrics, tampered release-gate source-context binding metrics, tampered release-gate public-eligibility metrics, tampered bundle/gate timing metrics, tampered gate-context metrics, tampered ready-evidence aggregate metrics, tampered primary source-pass metrics, tampered review/diversity source metrics, tampered source-count metrics, tampered source-problem count metrics, tampered source-coverage metrics, tampered source-presence metrics, tampered production-boundary metrics, tampered release-gate hash-match metrics, tampered candidate-review hash-match metrics, tampered candidate-review time-order metrics, tampered candidate-review count-match metrics, or tampered approval-evidence/candidate-review diagnostic counts fail validation. Bundle validation reports mirror present, missing, required, and supplied source counts, bounded release-gate source-context binding metrics, bounded approval-evidence/candidate-review diagnostic counts, plus production/private/default/V6 boundary indicators so QA can distinguish omitted bundle evidence, omitted validation inputs, source-context failures, evidence-diagnostic failures, and boundary failures without inspecting internals, and redact unsafe submitted bundle hashes, source pack ids, release modes, prerequisite keys, blocking reasons, boundary values, and metric values from measured evidence.

The evidence bundle has a generated-pack feature-gated API endpoint for QA review: `POST /api/world/generated-pack/release-evidence-bundle`. The endpoint and matching `et.world.generated_pack.release_evidence_bundle` tool return the release gate, release-gate validation, hash-bound bundle, and bundle validation report with mirrored source-count metrics, release-gate source-context binding metrics, bounded approval-evidence/candidate-review diagnostic counts, and production/private/default/V6 boundary indicators, including fail-closed private-data boundary failures and a ready controlled-release path when complete machine, persistence, approval, and candidate-review evidence is supplied. The HTTP and tool paths ignore loose approval inputs even when machine, persistence, and candidate-review evidence is otherwise complete; versioned approval evidence remains required. They remain hidden unless `FEATURE_WORLD_GRID_GENERATED_PACKS` is enabled and do not approve public release by themselves.
...
```json
{
  ...
  "releaseGateValidMetricTamperRejected": true,
  "releaseGateReadySourceEvidenceBound": true,
  "releaseGatePrerequisiteEvidenceBound": true,
  "releaseGateSourceContextMetricTamperRejected": true,
  "releaseGatePublicEligible": true,
  "releaseGatePublicEligibleMetricTamperRejected": true,
  "releaseGateHashMatches": true,
  "releaseGateHashMetricTamperRejected": true,
  "requiredSourceCount": 7,
  "presentSourceCount": 7,
  "missingSourceCount": 0,
  "sourceCountMetricTamperRejected": true,
  "sourceHashCount": 7,
  "sourceHashMismatchCount": 0,
  "sourceProblemMetricTamperRejected": true,
  "sourcePresenceMatchesHashes": true,
  "sourcePresenceMetricTamperRejected": true,
  "sourceCoverageOk": true,
  "sourceCoverageMetricTamperRejected": true,
  ...
  "bundleTimingMetricTamperRejected": true,
  ...
  "gateContextMetricTamperRejected": true,
  "readyEvidenceSourcesMatchGate": true,
  "readyEvidenceSourcesMetricTamperRejected": true,
  ...
  "primarySourcePassMetricTamperRejected": true,
  ...
  "reviewDiversitySourceMetricTamperRejected": true,
  ...
  "releaseEvidenceBundleDiagnosticMetricTamperRejected": true,
  "mixedDiversitySourceRejected": true,
  "approvalEvidenceGateDriftRejected": true,
  "candidateReviewManifestHashMatchesEvidence": true,
  "candidateReviewManifestHashMetricTamperRejected": true,
  "candidateReviewManifestTimeMatchesEvidence": true,
  "candidateReviewManifestCountsMatchEvidence": true,

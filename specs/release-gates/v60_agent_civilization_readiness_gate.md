...
for the V5 promotion target, feature flag safety, civic schemas, audit replay, mutation
...
- The research-only controlled release gate may exist in
  ...
  release manager, engineering, blocker register, release-candidate packet,
  operations, observability, and support-runbook acceptance,

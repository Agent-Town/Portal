...
Create the HQ cabin level 3 as a reusable standalone Founders Plot object.

## Positive prompt

Create a standalone HQ cabin level 3 for Agent Town, warm frontier storybook soft-3D collectible style, clean neutral background for cutout, readable silhouette, no text, no characters.
...
HQ cabin level 3 must sit cleanly on the Founders Plot stage and read immediately as a clickable world object.

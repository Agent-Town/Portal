---
assetId: founders_plot_market_stall_v1_4_2
...
outputTargets:
  - public/experiences/founders-plot/assets/buildings/market-stall.webp
...
Create the Market Stall as a reusable standalone Founders Plot object.

## Positive prompt

Create a standalone Market Stall for Agent Town, warm frontier storybook soft-3D collectible style, clean neutral background for cutout, readable silhouette, no text, no characters.
...
Market Stall must sit cleanly on the Founders Plot stage and read immediately as a clickable world object.

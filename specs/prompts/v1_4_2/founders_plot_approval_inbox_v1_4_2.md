...
outputTargets:
  - public/experiences/founders-plot/assets/objects/approval-inbox.webp
...
Create the Approval Inbox Bell Stand as a reusable Founders Plot civic object.

## Positive prompt

Create a standalone Approval Inbox Bell Stand for Agent Town, warm frontier storybook soft-3D collectible style, clean neutral background for cutout, readable at game size, no text, no characters.
...
Approval Inbox Bell Stand must be identifiable at a glance and not require labels to understand the click target.

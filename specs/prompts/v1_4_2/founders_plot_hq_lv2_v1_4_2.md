---
assetId: founders_plot_hq_lv2_v1_4_2
...
outputTargets:
  - public/experiences/founders-plot/assets/buildings/hq-lv2.webp
...
Create the HQ cabin level 2 as a reusable standalone Founders Plot object.

## Positive prompt

Create a standalone HQ cabin level 2 for Agent Town, warm frontier storybook soft-3D collectible style, clean neutral background for cutout, readable silhouette, no text, no characters.
...
HQ cabin level 2 must sit cleanly on the Founders Plot stage and read immediately as a clickable world object.

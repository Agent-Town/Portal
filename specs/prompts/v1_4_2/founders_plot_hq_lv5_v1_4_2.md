...
Create the HQ cabin level 5 as a reusable standalone Founders Plot object.

## Positive prompt

Create a standalone HQ cabin level 5 for Agent Town, warm frontier storybook soft-3D collectible style, clean neutral background for cutout, readable silhouette, no text, no characters.
...
HQ cabin level 5 must sit cleanly on the Founders Plot stage and read immediately as a clickable world object.

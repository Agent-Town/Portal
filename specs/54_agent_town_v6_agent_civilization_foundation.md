...
no public autonomous mutation. The hidden research proposal/vote routes and
internal worker proposal/vote adapters now consume scoped delegated budget
idempotently for successful receipts, but the gate remains non-executing with

...
- `validationReport.metrics` mirrors the source-pass booleans, approval-evidence hash binding, release-gate validity, release-gate public eligibility, bundle/gate timing booleans, gate-context binding booleans, and ready-evidence aggregate boolean above so QA can classify generated-pack, playtest, persistence, public-card, diversity, approval-evidence, candidate-review manifest, release-gate validity, release-gate eligibility, timestamp-coherence, blocking-reason, prerequisite-snapshot, and ready-source failures without inspecting internal checks;

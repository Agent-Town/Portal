...
Imports a generated-pack export into the current owner session. The server rejects tampered hashes, invalid generated-pack content, private owner fields, raw prompt fields, secret-like fields, secret-looking keys or values, and forbidden authority fields before saving. Final generated-pack validation reports redact submitted secret-looking key text from content and schema-error paths.

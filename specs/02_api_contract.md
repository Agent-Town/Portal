...
- `validationReport.metrics` mirrors direct release-gate auth/cost/consent, candidate-review binding, human-review, and approval-input/evidence matching indicators so HTTP/tool callers can classify approval failures without trusting loose approval inputs;

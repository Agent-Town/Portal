...
- `validationReport.metrics` mirrors source counts (`presentSourceCount`, `missingSourceCount`, `requiredSourceCount`, `suppliedSourceCount`), source-pass booleans, production/private/default/V6 boundary indicators (`productionImageAssetCount`, `privateDataLeakCount`, `productionImageAssetsCreated`, `externalProviderPrivateDataStored`, `canonicalServerRulesChanged`, `v6CivicMechanicsTouched`, `normalGameplayVisibilityChanged`, `generatedPackDefaultExposure`, `boundaryPreserved`), approval-evidence hash binding, release-gate validity, release-gate public eligibility, bundle/gate timing booleans, gate-context binding booleans, and ready-evidence aggregate boolean above so QA can classify omitted bundle evidence, omitted validation inputs, generated-pack, playtest, persistence, public-card, diversity, approval-evidence, candidate-review manifest, release-gate validity, release-gate eligibility, timestamp-coherence, blocking-reason, prerequisite-snapshot, boundary, and ready-source failures without inspecting internal checks;

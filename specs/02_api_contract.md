...
- forged eligibility, mismatched blocking reasons, approval evidence hash drift, approval evidence copied from another pack, secret-like fields, raw prompt instructions, production asset leaks, and private-card data fail validation;

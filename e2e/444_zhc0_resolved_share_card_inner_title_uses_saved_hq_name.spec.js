...
test('M44.22 resolved inner share-card title stays generic before HQ save and brands itself after HQ save', async ({ page, request }) => {
  ...
  await expect(shareFrame.getByTestId('share-card-title')).toHaveText('Share Card');

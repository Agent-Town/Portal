...
- Release-gate and release-evidence report measured fields must mirror production/private/default/V6 boundary indicators; release-evidence reports also mirror present, missing, required, and supplied source counts. They must redact unsafe submitted manifest hashes, evidence hashes, bundle hashes, pack ids, boundary values, and metric values before returning validation reports to callers.

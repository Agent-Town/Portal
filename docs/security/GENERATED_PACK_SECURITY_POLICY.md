...
- Release evidence report measured fields must mirror present, missing, required, and supplied source counts, and must redact unsafe submitted manifest hashes, evidence hashes, bundle hashes, and pack ids before returning validation reports to callers.

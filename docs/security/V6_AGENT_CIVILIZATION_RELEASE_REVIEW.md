...
| Audit coverage | Append-only ledger, owner indexes, migration versions, replay reconstruction, rollback handles | Research-only replay reconstruction plus audit-ledger, proposal/vote, reputation/moderation, and effect/rollback process restart probes exist; pending M16 release completion |

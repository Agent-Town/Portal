...
| Validation evidence | Targeted Node suite, split Playwright smokes, all-features regression, feature override safety | Includes mutation security, vote approval policy, and governance preflight contract coverage; pending release-candidate run |

...
| Validation evidence | Targeted Node suite, split Playwright smokes, all-features regression, feature override safety, store-backed delegation proof | Includes mutation security, vote approval policy, delegated-agent proof, and governance preflight contract coverage; pending release-candidate run |

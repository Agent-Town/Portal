...
invalidates current-session world-grid tokens, and optional SQLite rate-limit
...
replay, provider logout/disconnect CSRF invalidation wiring, IP/risk-aware

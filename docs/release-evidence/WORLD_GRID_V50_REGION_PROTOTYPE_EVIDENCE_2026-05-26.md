...
owner/surface route restart coverage, but release promotion still
requires durable owner indexes, migration versioning, complete exact per-record
before-state reconstruction for every store, durable idempotency integration with final
session-auth production replay, live Privy/provider logout signoff, IP/risk-aware

...
cleanup now has an explicit invalidation endpoint plus client hook, and optional
SQLite rate-limit rows now have owner/surface route restart coverage, but
release promotion still
...
replay, provider-specific logout callback signoff, IP/risk-aware

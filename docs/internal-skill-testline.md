...
| Experience UI intent tools (modal open / Atlas search / Registry search / Poker modal / Pony compose) | `public/skill.md`, `public/app.js`, `vendors/openclaw-lite-main/src/openclaw-lite/gateway.js`, `vendors/openclaw-lite-main/src/openclaw-lite/worker.js` | worker tools `agent_town_ui_open_modal`, `agent_town_ui_atlas_search`, `agent_town_ui_registry_search`, `agent_town_ui_pony_compose` dispatch through strict browser intent whitelist; Poker uses the same modal/embed policy as Registry and Atlas-friendly hub routing, with no route replacement or arbitrary DOM access | `e2e/108_experience_intent_open_modal.spec.js`, `e2e/109_experience_intent_atlas_search.spec.js`, `e2e/110_experience_intent_pony_compose.spec.js`, `e2e/130_registry_tool_projection_compat.spec.js`, `e2e/136_poker_modal_embed_policy.spec.js` |

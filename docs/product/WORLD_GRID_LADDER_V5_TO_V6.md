...
| V6.0 Agent Civilization Foundation | `research_only` | No | Worker-first civic tool draft and reputation accountability foundation exist under `server/world_civilization/`, but runtime civic tools remain hidden until V5 safety, rollback, redaction, retention, and civic-governance gates are proven. |

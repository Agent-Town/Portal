...
auth, provider logout/disconnect CSRF invalidation wiring, and IP/risk-aware
production rate limits remain promotion gates. Optional
...
world-grid CSRF tokens. Optional

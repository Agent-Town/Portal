...
auth, provider-specific logout callback signoff, and IP/risk-aware production
rate limits remain promotion gates. Optional
...
explicit invalidation endpoint plus client hook. Optional

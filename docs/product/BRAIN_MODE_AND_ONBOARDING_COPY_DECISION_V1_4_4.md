...
|---|---|---|---|
| Manual Founder Mode | Build, collect, accept starter goals manually | Guide basics, explain UI, no AGENT mutations | “Build manually now. Log in with ChatGPT when you want Clover to reason and act.” |
...
Clover will guide the basics. Log in with ChatGPT when you want Clover to reason and act as your Foreman.
```
...
- Brain sheet should lead with ChatGPT login and keep provider/model/API-key details in an advanced alternative.

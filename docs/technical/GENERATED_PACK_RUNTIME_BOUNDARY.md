...
- `validateProductionReleaseGate` checks schema validity, generated-pack id shape, diversity-suite release-pack inclusion, diversity metric-to-row coherence, same-pack persistence binding, same-pack public-card binding, prerequisite coherence, fail-closed behavior, release-gate timestamp coherence, explicit approval evidence, approval/candidate-review readiness mirroring, zero public/private asset leaks, and validation-report boundary indicators.
...
- Production release-gate validation reports mirror explicit auth/cost/consent, candidate-review binding, human-review, and production/private/default/V6 boundary indicators, and redact unsafe submitted release modes, prerequisite keys, blocking reasons, approval fields, and metric values from measured evidence.

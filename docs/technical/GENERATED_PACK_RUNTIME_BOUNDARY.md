...
- `validateProductionReleaseGate` checks schema validity, prerequisite coherence, fail-closed behavior, release-gate timestamp coherence, explicit approval evidence, and zero public/private asset leaks.

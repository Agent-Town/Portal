...
- CSRF-token and same-origin integration tests bound to the final
  ...
  invalidation for process-local and optional SQLite stores; final
  logout/session-reset invalidation wiring and session-auth integration remain
  gates.

...
- CSRF-token and same-origin integration tests bound to the final
  ...
  after `/api/session/world-grid-csrf/invalidate`; final provider-specific
  logout callback signoff and session-auth integration remain gates.

  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="bg-[#FFF9E6] border-4 border-[#FFD95A] shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)]">
        <CardHeader className="border-b-4 border-[#FFE466] bg-[#FFF4E0]">
          <div className="flex items-center gap-2">
            ...
            <Badge className="bg-[#FFD95A] text-[#2C4563] border-2 border-[#E5C14A] text-xs">Leadership</Badge>
          </div>
        ...
        <CardContent className="pt-6">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-4 bg-[#FFE6D9] border-4 border-[#FF9B7C] rounded-lg">
              <div className="flex flex-col items-center mb-4">
                <img 
                  src={lobsterSheriff} 
                  alt="OpenClaw Sheriff" 
                  className="w-48 h-48 rounded-lg border-4 border-[#2C4563] shadow-[4px_4px_0px_0px_rgba(0,0,0,0.4)] bg-[#FFF4E0]"
                />
                <h3 className="text-base font-semibold text-[#2C4563] mt-3">OpenClaw Sheriff</h3>
                <Badge className="bg-[#FF9B7C] text-white border-2 border-[#E87A5F] text-xs mt-2">OpenClaw Framework</Badge>
              </div>
              <div className="space-y-2 text-xs text-[#2C4563]">
                ...
                <p><span className="font-semibold">Body:</span> Bright coral/red, chunky rounded shell</p>
              ...
              <div className="mt-4 pt-3 border-t-2 border-[#FFB28C]">
                <p className="text-xs font-semibold text-[#2C4563] mb-2">Usage:</p>
                <ul className="text-xs text-[#2C4563] space-y-1 list-disc list-inside">
            ...
            <div className="p-4 bg-[#F0E6FF] border-4 border-[#A78BFA] rounded-lg">
              <div className="flex flex-col items-center mb-4">
                <img 
                  src={ladySheriff} 
                  alt="ElizaOS Sheriff" 
                  className="w-48 h-48 rounded-lg border-4 border-[#2C4563] shadow-[4px_4px_0px_0px_rgba(0,0,0,0.4)] bg-[#FFF4E0]"
                />
                <h3 className="text-base font-semibold text-[#2C4563] mt-3">ElizaOS Sheriff</h3>
                <Badge className="bg-[#A78BFA] text-white border-2 border-[#8B5CF6] text-xs mt-2">ElizaOS Framework</Badge>
              </div>
              <div className="space-y-2 text-xs text-[#2C4563]">
              ...
              <div className="mt-4 pt-3 border-t-2 border-[#C4B5FD]">
                <p className="text-xs font-semibold text-[#2C4563] mb-2">Usage:</p>
                <ul className="text-xs text-[#2C4563] space-y-1 list-disc list-inside">
          ...
          <div className="mt-6 p-4 bg-[#FFF4E0] border-2 border-[#FFD95A] rounded-lg">
            <p className="text-xs text-[#2C4563] leading-relaxed">
              <span className="font-semibold text-[#2C4563]">Design Note:</span> Both sheriffs wear the iconic 
      ...
      <Card className="bg-[#FFF4E0] border-4 border-[#2C4563] shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)]">
        <CardHeader className="border-b-4 border-[#5B9BD5]">
          <CardTitle className="text-[#2C4563]">Character Design Philosophy</CardTitle>
        </CardHeader>
        <CardContent className="pt-6">
          ...
          <div className="flex flex-wrap gap-2">
            <Badge className="bg-[#5B9BD5] text-white border-2 border-[#4A8DC7] text-xs">Chibi Proportions</Badge>
            <Badge className="bg-[#FF9B7C] text-white border-2 border-[#E87A5F] text-xs">Large Expressive Eyes</Badge>
            <Badge className="bg-[#FFD95A] text-[#2C4563] border-2 border-[#E5C14A] text-xs">Simple Silhouettes</Badge>
            <Badge className="bg-[#A78BFA] text-white border-2 border-[#8B5CF6] text-xs">Diverse & Inclusive</Badge>
          </div>
        </CardContent>
      </Card>

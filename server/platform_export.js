...
const PRIMARY_KEY_BY_TABLE = Object.freeze({
  ...
  library_public_stack_safety_records: 'library_public_stack_safety_record_id',
  library_public_stack_attestations: 'library_public_stack_attestation_id',
  library_public_stack_attestation_provenance: 'library_public_stack_attestation_provenance_id',
  library_public_stack_attestation_verification_receipts: 'library_public_stack_attestation_verification_receipt_id',
  library_route_subscriptions: 'library_route_subscription_id',
  library_route_sync_receipts: 'library_route_sync_receipt_id',

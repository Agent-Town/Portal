...
const PRIMARY_KEY_BY_TABLE = Object.freeze({
  ...
  house_staff_assignments: 'assignment_id',
  house_worker_deployments: 'deployment_id',
  house_worker_shares: 'share_id',
  house_worker_share_invites: 'share_invite_id',
  house_worker_sessions: 'house_worker_session_id',
  house_worker_executor_nodes: 'local_node_id',
  house_worker_runtime_instances: 'runtime_instance_id',
  house_worker_workspace_snapshots: 'workspace_snapshot_ref',
  house_worker_transport_messages: 'transport_message_id',
  house_worker_session_events: 'house_worker_session_event_id',

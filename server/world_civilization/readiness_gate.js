...
const REQUIRED_V6_READINESS_GATES = [
  ...
  },
  {
    ...
    requiredChecks: [
      ...
      'csrf',
      'session_wallet_auth',
      'session_wallet_continuity_targets',
      'provider_disconnect_invalidation_target',
      'route_tool_session_auth_target',
      'production_browser_session_coverage_target',
      'risk_aware_rate_limit_identity_target',
  ...
  },
  {
    ...
    requiredChecks: [
      ...
      'browser_worker_runtime_registration_target',
      'production_browser_worker_coverage_target',

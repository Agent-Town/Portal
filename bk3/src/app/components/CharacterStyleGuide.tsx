...
export default function CharacterStyleGuide() {
  return (
    <div className="space-y-4">
      ...
      <Card className="bg-[#FDF2F8] border-4 border-[#EC4899] shadow-[4px_4px_0px_0px_rgba(0,0,0,0.5)] shadow-[0_0_15px_rgba(236,72,153,0.4)]">
        <CardHeader className="border-b-4 border-[#F9A8D4] bg-[#F0F0FF]">
          <div className="flex items-center gap-2">
            <CardTitle className="text-[#1E1B4B] flex items-center gap-2">
              <span className="text-[#EC4899]">★★</span> Town Bosses <span className="text-[#EC4899]">★★</span>
            </CardTitle>
            <Badge className="bg-[#EC4899] text-white border-2 border-[#DB2777] text-xs shadow-[0_0_8px_rgba(236,72,153,0.3)]">Leadership</Badge>
          </div>
          <CardDescription className="text-xs text-[#831843]">
        ...
        <CardContent className="pt-6">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-4 bg-[#FCE7F3] border-4 border-[#EC4899] rounded-lg shadow-[0_0_12px_rgba(236,72,153,0.2)]">
              <div className="flex flex-col items-center mb-4">
                <img 
                  src={lobsterSheriff} 
                  alt="OpenClaw Sheriff" 
                  className="w-48 h-48 rounded-lg border-4 border-[#312E81] shadow-[4px_4px_0px_0px_rgba(0,0,0,0.4)] shadow-[0_0_15px_rgba(236,72,153,0.5)] bg-[#F0F0FF]"
                />
                <h3 className="text-base font-semibold text-[#1E1B4B] mt-3">OpenClaw Sheriff</h3>
                <Badge className="bg-[#EC4899] text-white border-2 border-[#DB2777] text-xs mt-2 shadow-[0_0_8px_rgba(236,72,153,0.3)]">OpenClaw Framework</Badge>
              </div>
              <div className="space-y-2 text-xs text-[#1E1B4B]">
                ...
                <p><span className="font-semibold">Body:</span> Bright coral/red with magical glow</p>
              ...
              <div className="mt-4 pt-3 border-t-2 border-[#F9A8D4]">
                <p className="text-xs font-semibold text-[#1E1B4B] mb-2">Usage:</p>
                <ul className="text-xs text-[#1E1B4B] space-y-1 list-disc list-inside">
            ...
            <div className="p-4 bg-[#CFFAFE] border-4 border-[#06B6D4] rounded-lg shadow-[0_0_12px_rgba(6,182,212,0.2)]">
              <div className="flex flex-col items-center mb-4">
                <img 
                  src={ladySheriff} 
                  alt="ElizaOS Sheriff" 
                  className="w-48 h-48 rounded-lg border-4 border-[#312E81] shadow-[4px_4px_0px_0px_rgba(0,0,0,0.4)] shadow-[0_0_15px_rgba(6,182,212,0.5)] bg-[#F0F0FF]"
                />
                <h3 className="text-base font-semibold text-[#1E1B4B] mt-3">ElizaOS Sheriff</h3>
                <Badge className="bg-[#06B6D4] text-white border-2 border-[#0891B2] text-xs mt-2 shadow-[0_0_8px_rgba(6,182,212,0.3)]">ElizaOS Framework</Badge>
              </div>
              <div className="space-y-2 text-xs text-[#1E1B4B]">
                ...
                <p><span className="font-semibold">Hair:</span> Long black hair with cyan highlights</p>
                <p><span className="font-semibold">Hat:</span> Brown sheriff hat with golden star</p>
                <p><span className="font-semibold">Outfit:</span> Tech-enhanced frontier gear</p>
                <p><span className="font-semibold">Personality:</span> Welcoming, organized, collaborative</p>
              </div>
              <div className="mt-4 pt-3 border-t-2 border-[#A5F3FC]">
                <p className="text-xs font-semibold text-[#1E1B4B] mb-2">Usage:</p>
                <ul className="text-xs text-[#1E1B4B] space-y-1 list-disc list-inside">
          ...
          <div className="mt-6 p-4 bg-[#F0F0FF] border-2 border-[#8B5CF6] rounded-lg shadow-[0_0_12px_rgba(139,92,246,0.2)]">
            <p className="text-xs text-[#1E1B4B] leading-relaxed">
              <span className="font-semibold text-[#8B5CF6]">Design Note:</span> Both sheriffs wear the iconic 
      ...
      <Card className="bg-[#F0F0FF] border-4 border-[#312E81] shadow-[4px_4px_0px_0px_rgba(0,0,0,0.5)] shadow-[0_0_15px_rgba(139,92,246,0.3)]">
        <CardHeader className="border-b-4 border-[#8B5CF6] bg-gradient-to-r from-[#8B5CF6]/10 to-[#06B6D4]/10">
          <CardTitle className="text-[#1E1B4B]">Character Design Philosophy</CardTitle>
        </CardHeader>
        <CardContent className="pt-6">
          ...
          <div className="flex flex-wrap gap-2">
            <Badge className="bg-[#8B5CF6] text-white border-2 border-[#7C3AED] text-xs shadow-[0_0_8px_rgba(139,92,246,0.3)]">Chibi Proportions</Badge>
            <Badge className="bg-[#06B6D4] text-white border-2 border-[#0891B2] text-xs shadow-[0_0_8px_rgba(6,182,212,0.3)]">Large Expressive Eyes</Badge>
            <Badge className="bg-[#EC4899] text-white border-2 border-[#DB2777] text-xs shadow-[0_0_8px_rgba(236,72,153,0.3)]">Simple Silhouettes</Badge>
            <Badge className="bg-[#FFD95A] text-[#1E1B4B] border-2 border-[#E5C14A] text-xs">Diverse & Inclusive</Badge>
          </div>
        </CardContent>
      </Card>
